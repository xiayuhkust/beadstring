...
T_ES = [
  ...
  ('the lead verse can be joined to any verse below — what passes between them is yours to write',
   'el versículo guía puede unirse a cualquiera de los de abajo — lo que pasa entre ellos te toca escribirlo a ti'),
  ('＋ Join the Lead to This Verse', '＋ Unir el Versículo Guía a Este'),
  ('two centuries of stringers also joined this pair · ',
   'dos siglos de ensartadores también unieron este par · '),
...
T_PT = [
  ...
  ('the lead verse can be joined to any verse below — what passes between them is yours to write',
   'o versículo guia pode ser ligado a qualquer um abaixo — o que passa entre eles cabe a você escrever'),
  ('＋ Join the Lead to This Verse', '＋ Ligar o Versículo Guia a Este'),
  ('two centuries of stringers also joined this pair · ',
   'dois séculos de enfiadores também ligaram este par · '),
  ('What did this chain bring you today… (optional — only you can see it)',
