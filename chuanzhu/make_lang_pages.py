...
T_ES = [
  ...
  ('>community<', '>comunidad<'),
  ('community additions · ', 'aportes de la comunidad · '),
  ('>The Daily String<', '>La Sarta Diaria<'),
  ('What did this chain bring you today… (optional — only you can see it)',
   'Qué te trajo hoy esta cadena… (opcional — solo tú puedes verlo)'),
  ('evening review — read it once more; is the morning light still there',
   'repaso de la noche — léela una vez más; ¿sigue ahí la luz de la mañana?'),
  ('Marked in your stringing days · come back tonight to read it again',
   'Anotado en tus días de ensartar · vuelve esta noche a leerla otra vez'),
  ('arrangement · Daily Light, 1875 — four generations of handwork',
   'arreglo · Daily Light, 1875 — cuatro generaciones de trabajo manual'),
  ('Tonight · Read It Again', 'Esta Noche · Léela Otra Vez'),
  ('Today’s chain is strung.<br>Come back tonight and read it once more.',
   'La cadena de hoy está ensartada.<br>Vuelve esta noche y léela una vez más.'),
  ("'Daily · '", "'Diario · '"),
  ("' · review'", "' · repaso'"),
  ('>any<', '>todo<'),
  ('>bright<', '>claro<'),
  ('>deep<', '>profundo<'),
  ('bright — the two passages share the same words, plain to see',
   'claro — los dos pasajes comparten las mismas palabras, a simple vista'),
  ('deep — almost no shared words; the join hides beneath the surface',
   'profundo — casi sin palabras en común; el vínculo se esconde bajo la superficie'),
  ('>All<', '>Todos<'),
  ('>Community<', '>Comunidad<'),
  ('>Offer This New Thread to the Community<', '>Ofrecer Este Hilo Nuevo a la Comunidad<'),
  ('>A New Pair · Offer This Bead to the Community<', '>Un Par Nuevo · Ofrecer Esta Cuenta a la Comunidad<'),
  ("'Offer This New Thread to the Community'", "'Ofrecer Este Hilo Nuevo a la Comunidad'"),
  ("'A New Pair · Offer This Bead to the Community'", "'Un Par Nuevo · Ofrecer Esta Cuenta a la Comunidad'"),
  ('＋ Join This Verse to Another Place…', '＋ Unir Este Versículo a Otro Lugar…'),
  ('no beads on this verse yet — you could tie the first thread', 'aún no hay cuentas en este versículo: podrías atar el primer hilo'),
  ('Join To · Choose a Book', 'Unir a · Elige un Libro'),
  ('>pick the verse<', '>elige el versículo<'),
  ('Both ends are in the same chapter — choose another.', 'Ambos extremos están en el mismo capítulo: elige otro.'),
  ('TSK already strings these two chapters (', 'TSK ya ensarta estos dos capítulos ('),
  (' verse-level records) — worth a look in the list. Tie your own thread anyway?', ' registros a nivel de versículo): mira la lista primero. ¿Atar tu propio hilo de todos modos?'),
  ('>String It<', '>Ensártala<'),
...
T_PT = [
  ...
  ('community additions · ', 'adições da comunidade · '),
  ('>The Daily String<', '>O Fio Diário<'),
  ('What did this chain bring you today… (optional — only you can see it)',
   'O que esta corrente trouxe a você hoje… (opcional — só você pode ver)'),
  ('evening review — read it once more; is the morning light still there',
   'revisão da noite — leia mais uma vez; a luz da manhã ainda está aí?'),
  ('Marked in your stringing days · come back tonight to read it again',
   'Marcado nos seus dias de enfiar · volte à noite para ler de novo'),
  ('arrangement · Daily Light, 1875 — four generations of handwork',
   'arranjo · Daily Light, 1875 — quatro gerações de trabalho manual'),
  ('Tonight · Read It Again', 'Esta Noite · Leia de Novo'),
  ('Today’s chain is strung.<br>Come back tonight and read it once more.',
   'A corrente de hoje está enfiada.<br>Volte esta noite e leia mais uma vez.'),
  ("'Daily · '", "'Diário · '"),
  ("' · review'", "' · revisão'"),
  ('>any<', '>tudo<'),
  ('>bright<', '>claro<'),
  ('>deep<', '>profundo<'),
  ('bright — the two passages share the same words, plain to see',
   'claro — as duas passagens compartilham as mesmas palavras, à vista de todos'),
  ('deep — almost no shared words; the join hides beneath the surface',
   'profundo — quase sem palavras em comum; o vínculo se esconde sob a superfície'),
  ('>All<', '>Todos<'),
  ('>Community<', '>Comunidade<'),
  ('>Offer This New Thread to the Community<', '>Oferecer Este Fio Novo à Comunidade<'),
  ('>A New Pair · Offer This Bead to the Community<', '>Um Par Novo · Oferecer Esta Conta à Comunidade<'),
  ("'Offer This New Thread to the Community'", "'Oferecer Este Fio Novo à Comunidade'"),
  ("'A New Pair · Offer This Bead to the Community'", "'Um Par Novo · Oferecer Esta Conta à Comunidade'"),
  ('＋ Join This Verse to Another Place…', '＋ Ligar Este Versículo a Outro Lugar…'),
  ('no beads on this verse yet — you could tie the first thread', 'ainda não há contas neste versículo — você poderia atar o primeiro fio'),
  ('Join To · Choose a Book', 'Ligar a · Escolha um Livro'),
  ('>pick the verse<', '>escolha o versículo<'),
  ('Both ends are in the same chapter — choose another.', 'As duas pontas estão no mesmo capítulo — escolha outro.'),
  ('TSK already strings these two chapters (', 'TSK já enfia estes dois capítulos ('),
  (' verse-level records) — worth a look in the list. Tie your own thread anyway?', ' registros no nível do versículo) — vale ver a lista. Atar seu próprio fio mesmo assim?'),
  ('>String It<', '>Enfie-a<'),
