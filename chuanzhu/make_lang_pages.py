...
T_ES = [
  ...
  ('>The Daily Portion<', '>La Porción Diaria<'),
  ...
  ('Today’s portion is read.<br>Come back tonight and read it once more.',
   'La porción de hoy está leída.<br>Vuelve esta noche y léela una vez más.'),
  ("'Daily · '", "'Diario · '"),
  ("' · review'", "' · repaso'"),
  ('>any<', '>todo<'),
  ('>bright<', '>claro<'),
...
T_PT = [
  ...
  ('>The Daily Portion<', '>A Porção Diária<'),
  ('What did this chain bring you today… (optional — only you can see it)',
